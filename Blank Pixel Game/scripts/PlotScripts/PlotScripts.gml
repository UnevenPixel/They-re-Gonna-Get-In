...
///        repeating instance_create_layer + four field assignments inline.
///        oBuildingPlot's inside/far/blocked/team fields are declared as
///        Object Properties (IDE-level, with defaults) rather than in its
///        Create event -- that's this object's existing convention, not
